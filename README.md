...
+ Ping Pong: The node will move all the points until it reaches the last one. Then it switches direction and starts moving backwards in those points until it reaches the first one. Then it starts moving forward again.
